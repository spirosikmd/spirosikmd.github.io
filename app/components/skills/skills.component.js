System.register(['angular2/core', "./skillItem.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, skillItem_component_1;
    var SkillsComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            SkillsComponent = (function () {
                ...
                SkillsComponent = __decorate([
                    core_1.Component({
                        selector: 'skills',
                        directives: [skillItem_component_1.SkillItemComponent],
