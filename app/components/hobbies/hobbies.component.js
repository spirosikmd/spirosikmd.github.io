System.register(['angular2/core', "./hobbyItem.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, hobbyItem_component_1;
        ...
        execute: function() {
            HobbiesComponent = (function () {
                ...
                HobbiesComponent = __decorate([
                    core_1.Component({
                        selector: 'hobbies',
                        directives: [hobbyItem_component_1.HobbyItemComponent],
